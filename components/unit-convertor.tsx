...
export default function UnitConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen flex-wrap bg-yellow-100 dark:bg-gray-900">
      {/* Center the unit converter card within the screen */}
      <div className="max-w-md w-full p-6 bg-yellow-50 rounded-lg shadow-lg">
